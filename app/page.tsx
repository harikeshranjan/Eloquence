    ...
    <div className="my-10">
      <div className="flex flex-col items-center justify-center space-y-7">
        ...
        <div className="flex items-center justify-center">
          <Button className="flex items-center justify-center bg-gradient-to-r from-purple-500 to-blue-500 text-white hover:from-purple-600 hover:to-blue-600 text-lg font-light p-6 rounded shadow-lg transition duration-300 ease-in-out cursor-pointer">
            Get Started <ArrowRight className="h-5 w-5" />
          </Button>
          <Button variant={"secondary"} className="ml-4 flex items-center justify-center text-lg font-light p-6 rounded shadow-lg transition duration-300 ease-in-out cursor-pointer">
            Learn More
          </Button>
        </div>
      </div>
